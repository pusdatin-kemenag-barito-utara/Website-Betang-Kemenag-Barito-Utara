    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
      <div className="w-full max-w-2xl animate-in zoom-in-95 rounded-3xl bg-white shadow-2xl ring-1 ring-slate-200 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto custom-scrollbar flex-1">
          ...
          {/* Banner Opsi Ekstraksi ZIP jika terdeteksi berkas ZIP dalam antrean */}
          {zipItems.length > 0 && (
                      ...
                      <div className="flex items-center gap-2.5 min-w-0 flex-1 pr-2">
                        ...
                        <div className="flex flex-col min-w-0">
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-semibold text-slate-800 truncate" title={item.relativePath || item.file.name}>
                              {item.file.name}
                            </span>
                            {isZip && (
